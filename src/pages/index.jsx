  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex px-4 sm:px-24 justify-start gap-5 overflow-x-scroll scrollbar-hide py-4 sm:gap-8">
        {[image2, image3, image4, image1, image5, image6, image7, image8].map((image, _) => (
          <div
            key={image.src}
            className={clsx(
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Mohnish, I love building software aimed at improving peoples' lives."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-7xl">
          ...
          <p className="mt-2 text-base text-zinc-600 text-lg dark:text-zinc-300">
            If you’re interested, <a className='text-underline text-blue-400' href="https://calendar.app.google/pTwG36mGJP8MYB47A">let&apos;s chat</a>.
          </p>
          <p></p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/mohnish.aggarwal01/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/mohnishaggarwal"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/mohnish-aggarwal-9982a3207/"
